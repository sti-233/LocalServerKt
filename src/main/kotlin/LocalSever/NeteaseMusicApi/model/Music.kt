package LocalSever.NeteaseMusicApi.model
...
@Serializable data class User(val name: String, val avatarUrl: String)
@Serializable data class UserData(val id: String, val token: String)
